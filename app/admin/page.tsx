                ...
                <div className="drawer-side">
                    ...
                    <ul className="menu p-4 py-2  w-80 min-h-full bg-base-200 text-base-content">
                        ...
                        <div className='py-2 px-4 flex gap-2 items-center'>
                            <Image src='/assets/profilephoto.jpg' className='rounded-[50%]' height={40} width={40} alt="user" />
                            <div>
                        ...
                        {tabs?.map((t, index) => {
                            return (
                                <li key={index} onClick={() => setCurrent(t?.label)}><a className={t?.label == current ? "text-blue-400" : ""} >{t?.label}</a></li>
                            )
                        })}
