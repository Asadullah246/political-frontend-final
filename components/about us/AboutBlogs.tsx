    ...
    return (
        <div className="">
            ...
            <div className="relative w-full h-[600px]">
                ...
                <div className="absolute inset-0 filter brightness-[50%] w-full h-full " style={{ backgroundImage: `url(/assets/blog-v1-3.jpg)`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                </div>
                <div className="w-full h-full absolute  flex justify-center items-center z-[3] text-white text-center  ">
                    <div>
                        ...
                        <LargeTitle className="mt-4 font-bold leading-10  tracking-wider">Our Blogs to <br />
