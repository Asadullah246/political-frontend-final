...
const Testimonial: React.FC= () => { 
    ...
    const reviews: ReviewItem[]=[
        ...
        },
        {
            ...
            image:reviewImg3,
            designation:"politician",
            comment:"   accusantium, officiis temporibus consequuntur reiciendis culpa adipisicing elit. Alias odio deleniti corrupti fugiat."
    ...
    return (
       ...
       <div className='mt-12 '>
            <SectionTittle title='TESTIMONIALS' description='We are Very Glad to Get ' span='People Review'/>
       <div className=''>
       <Carousel
                swipeable={false}
                draggable={true}
            ...
            >
               ...
               reviews?.map((r,index)=>{
                return (
                <div key={r._id} className='mx-6 relative  '
                data-aos="fade-up"
