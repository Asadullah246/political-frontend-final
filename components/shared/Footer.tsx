        ...
        ref={footerRef}
         className="bg-[#151515] text-white pb-16 footer ">
           ...
           <div className="container">
               {/* <div className="flex gap-4 lg:gap-4   flex-col lg:flex-row items-start lg:items-center  justify-around ">

                   <h3 className="uppercase text-3xl font-bold">Company</h3>


                   <div className="flex gap-4 lg:gap-4  flex-col lg:flex-row items-start lg:items-center  ">

                       <div>
                           <h6 className="text-lg font-bold ">Subscribe to us</h6>
                       </div>

                       <div className="flex w-full md:w-[450px]    items-center space-x-2">
                           <NoSSRInput type="email" placeholder="Email" className="text-black " />
                           <Button type="submit" className="relative z-[5] bg-[#FFC400] text-black px-4  md:px-10 text-lg hover:bg-[#ffc40081] hover:text-white " >Submit</Button>
                       </div>
                   </div>
